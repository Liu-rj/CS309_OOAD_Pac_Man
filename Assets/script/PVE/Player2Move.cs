...
public class Player2Move : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider col)
    {
        if (col.gameObject.CompareTag("food"))
        {
            ...
            Debug.Log("opp_score:"+Player1Move.score+"totalscore:"+total_score);
            /*
            ...
            */
            if (score + Player1Move.score == total_score)
            {
                Debug.Log("score:"+score+"totalscore:"+total_score);
                if (score > Player1Move.score)
                {
                    victory.text = "Player2 Win!";
                    exit = true;
                }
                else if (score == Player1Move.score)
                {
                    victory.text = "Draw!";
                    exit = true;
                }
        ...
        if (col.gameObject.CompareTag("ghost"))
        {
            ...
            else
            {
                ...
                //    exit = true;
                //}
                if (_hp == 0 && Player1Move._hp > 0)
                {
                    victory.text = "Player1 Win!";
                    exit = true;
                }
                else if (_hp > 0 && Player1Move._hp == 0)
                {
                    victory.text = "Player2 Win!";
                    exit = true;
                }
